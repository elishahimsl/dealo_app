  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: bg }]}>
      <View style={styles.header}>
        ...
        <Text style={[styles.headerTitle, { color: textPrimary }]}>About</Text>
      ...
      <View style={[styles.card, { backgroundColor: surface1, borderColor: border }]}> 
        ...
        <Text style={[styles.body, { color: textSecondary }]}>This section will include app details, version info, and credits.</Text>
      </View>
    </SafeAreaView>
  );
}
