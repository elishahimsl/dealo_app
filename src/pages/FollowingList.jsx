...
export default function FollowingList() {
  ...
  const [followedStores, setFollowedStores] = useState([
    { id: 1, name: "Nike", logo: "https://logo.clearbit.com/nike.com", following: true },
    { id: 2, name: "Adidas", logo: "https://logo.clearbit.com/adidas.com", following: true },
    { id: 3, name: "Target", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Target_logo.svg/1200px-Target_logo.svg.png", following: true },
    { id: 4, name: "Amazon", logo: "https://logo.clearbit.com/amazon.com", following: true },
    { id: 5, name: "Best Buy", logo: "https://logo.clearbit.com/bestbuy.com", following: true },
  ]);

  const handleToggleFollow = (storeId) => {
    setFollowedStores(prev => 
      prev.map(store => 
        store.id === storeId ? { ...store, following: !store.following } : store
      )
    );
  };
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] pb-24">
      ...
      <div className="px-6 space-y-3">
        {followedStores.filter(s => s.following).map((store) => (
