        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-2">
            <button className="bg-[#E8F5F1] rounded-2xl p-3 text-center shadow-md hover:shadow-xl transition-shadow">
              ...
              <p className="text-xs font-semibold text-[#1F2937]">PriceDrop</p>
            </button>
            <button 
            ...
            >
              ...
              <p className="text-xs font-semibold text-[#1F2937]">DeaLo AI</p>
            </button>
            <button 
            ...
            >
              ...
              <p className="text-xs font-semibold text-[#1F2937]">Deal Scanner</p>
            </button>
          </div>
        </div>
